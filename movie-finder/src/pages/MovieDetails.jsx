...
import Backup from "../assets/your-fault.jpg"
...
const MovieDetails = () => {
  ...
  const { id, original_title, overview, poster_path, genres, vote_average, vote_count } = date;
...
<div class="flex items-center justify-center lg:justify-start">
    ...
    <p class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400">{vote_average}</p>
    <p class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400">out of</p>
    <p class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400">{vote_count }</p>
</div>
